		...
		<div class="result">
				...
				<ul>
					<li class="user-info">
						<div class="user-info-container">
							<div class="main">统计信息</div>
							<div class="children" id="data-info">
								<ul class="children-list">
									<li id="children-user-name">${u_name}</li>
									<li id="children-user-exit">退出登录</li>
								</ul>
							</div>
						</div>
					</li>
					<li class="data-info">
						<div class="data-info-container">
							...
							<div class="children" id="data-info">
								<ul class="children-list">
									<li id="children-chart-table"  class="select">统计</li>
								</ul>
							</div>
						</div>
					</li>
			...
			<div class="content">
				<div class="rt-container">
					...
					<div class="rt-des" style="display:none">
						<div>
							<span>编号</span>
						</div>
						<div>
					...
					<div class="rt-contents" style="display:none">
						<div id="pageLoad"></div>
					</div>
					<div class="rt-chart">
						<div id="gzh" style="width: 800px;height:600px;" class="chart"></div>
						<div id="article" style="width: 800px;height:600px;" class="chart"></div>
					</div>
				</div>
			</div>
		</div>
					...
					if(options.target==='handleWxNum'){
						...
						$('.rt-content .rt-refresh span').on('click',function(e){
							...
							global.subData('/CLI/'+options.target+'Op',{action:'refresh',target:id},function(data){
								if(data.state){
									//更新完刷新页面
									HJLoading.stop('loading');
									$('body .container').loadingOverlay('remove');
...
/* 					setTimeout(function(){
			...
			//分页加载
			//1.对初始的分页
/* 			$('.data-info .children .children-list li').on('click',function(e){
				container.find('.rt-des').remove();
				container.find('.rt-contents').css({
					display:'none'
				});
				var chart = '<div id="gzh" style="width: 600px;height:450px;"></div><div id="article" style="width: 600px;height:450px;"></div>';
...
/* 			pageLoad(page, {
			...
			lis.each(function(index, value) {
				$(value).on('click', function() {
					...
					case 'chart':{
						if(state!='chart'){
							container.find('.rt-des')?container.find('.rt-des').remove():'';
							container.find('.rt-contents')?container.find('.rt-contents').css({
								display:'none'
							}):'';
							container.find('.chart')?container.find('.chart').css({
								display:'block'
							}):'';
						}
						state='chart';
	...
	<script type="text/javascript">    
        ...
        //公众号
                // 基于准备好的dom，初始化echarts图表
        var myChart = echarts.init(document.getElementById('gzh')); 
        var key1 = '${key1}';
        var key2 = '${key2}';
        var key3 = '${key3}';
        var key4 = '${key4}';
        ...
        option = {
		    ...
		    xAxis : [
		        {
		            type : 'category',
		            data : ['省级公众号', '市级公众号', '县区级公众号', '个人公众号', '未知公众号']
		        },
		        {
		            type : 'category',
		            axisLine: {show:false},
		    ...
		    series : [
		        {
		            ...
		            data:[keyArr1[0],keyArr1[1],keyArr1[2],keyArr1[3],keyArr1[4]]
		        },
		        {
		            name:'关键词——中国人寿',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(181,195,52,1)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr2[0],keyArr2[1],keyArr2[2],keyArr2[3],keyArr2[4]]
		        },
		        {
		            name:'关键词——人寿',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(181,195,52,0.5)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr3[0],keyArr3[1],keyArr3[2],keyArr3[3],keyArr3[4]]
		        },
		        {
		            name:'关键词——寿险',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(252,206,16,0.5)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr4[0],keyArr4[1],keyArr4[2],keyArr4[3],keyArr4[4]]
		        }
		    ]
		};
		    ...
		    series : [
		        {
		            ...
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(252,206,16,1)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr1[5],keyArr1[6],keyArr1[7],keyArr1[8]]
		        },
		        {
		            name:'关键词——中国人寿',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(181,195,52,1)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr2[5],keyArr2[6],keyArr2[7],keyArr2[8]]
		        },
		        {
		            name:'关键词——人寿',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(181,195,52,0.5)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr3[5],keyArr3[6],keyArr3[7],keyArr3[8]]
		        },
		        {
		            name:'关键词——寿险',
		            type:'bar',
		            itemStyle: {normal: {color:'rgba(252,206,16,0.5)', label:{show:true,textStyle:{color:'#27727B'}}}},
		            data:[keyArr4[5],keyArr4[6],keyArr4[7],keyArr4[8]]
		        }
		    ]
		};
